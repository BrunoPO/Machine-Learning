...
public class TrackManager : MonoBehaviour
{
    ...
    /// </summary>
    public CarUserControl PrototypeCar;
    ...
    {
        public RaceCar(CarUserControl car = null, uint checkpointIndex = 1)//
        {
            this.Car = car;
    ...
    /// </summary>
    public event System.Action<CarUserControl> BestCarChanged;

    private CarUserControl secondBestCar = null;
    /// <summary>
    /// The current second best car (furthest in the track).
    /// </summary>
    public CarUserControl SecondBestCar
    {
    ...
    /// </summary>
    public event System.Action<CarUserControl> SecondBestCarChanged;
    #endregion
    ...
    public void SetCarAmount(int amount)
    {
        ...
        if (amount > cars.Count)
        {
            ...
            for (int toBeAdded = amount - cars.Count; toBeAdded > 0; toBeAdded--)
            {
                ...
                CarUserControl controllerCopy = carCopy.GetComponent<CarUserControl>();
    ...
    /// </summary>
    public IEnumerator<CarUserControl> GetCarEnumerator()//CarUserControl
    {
        for (int i = 0; i < cars.Count; i++)
    ...
    private float GetCompletePerc(CarUserControl car, ref uint curCheckpointIndex)
    {
